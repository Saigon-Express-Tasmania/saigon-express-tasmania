  ...
  return (
    <div className="min-h-screen bg-brand-cream text-brand-dark">
      ...
      <section className="py-20 lg:py-28 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1a0a00 0%, #2d0f00 40%, #1a0a00 100%)" }}>
        ...
        <div className="max-w-[1280px] mx-auto px-4 grid lg:grid-cols-[3fr_2fr] gap-8 items-center">
          ...
          <div className="relative overflow-hidden rounded-sm reveal shadow-2xl">
            <div className="relative w-full h-[520px]"><AppImage src={IMGS.ourFood} alt="Our Vietnamese food" fill className="object-cover" /></div>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative reveal">
            <div className="relative w-full h-[480px] rounded-sm overflow-hidden"><AppImage src={IMGS.catering} alt="Saigon Express catering" fill className="object-cover rounded-sm" /></div>
            {/* Floating card */}
            <div className="absolute bottom-6 right-6 bg-white rounded-sm shadow-xl p-4 max-w-[180px]">
              <AppImage src={IMGS.cateringBox} alt="Catering box" width={320} height={96} className="w-full h-24 object-cover rounded-sm mb-2" />
      ...
      <section className="relative py-28 overflow-hidden">
        <AppImage src="/manus-storage/IMG_4152Large_d9da7044.png" alt="Saigon Express food spread" fill className="object-cover" />
      ...
      <section className="bg-brand-dark py-20 lg:py-28">
        <div className="max-w-[1280px] mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div className="reveal">
            <div className="relative w-full h-[400px] rounded-sm overflow-hidden"><AppImage src={IMGS.wholesale} alt="Wholesale supply" fill className="object-cover rounded-sm" /></div>
          </div>
          <div className="reveal" style={{ animationDelay: "0.15s" }}>
      ...
      <footer className="bg-brand-dark text-white/70">
        <div className="max-w-[1280px] mx-auto px-4 pt-16 pb-8">
          <div className="grid md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-12">
            ...
            {/* Brand col */}
            <div>
              <AppImage src={LOGO_URL} alt="Saigon Express Tasmania" width={200} height={48} className="h-12 w-auto object-contain mb-5" />
