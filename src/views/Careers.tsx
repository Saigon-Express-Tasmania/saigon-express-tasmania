...
const JOBS = [
  {
    ...
    summary:
      "Lead our kitchen brigade across our busiest locations. You will own the wok station, set the quality standard for every dish that leaves the pass, and mentor junior kitchen staff in authentic Vietnamese cooking techniques.",
    responsibilities: [
    ...
    perks: [
      "30% staff meal discount",
      "Career progression to Head Chef",
      "Training in our central kitchen",
      "Uniform provided",
    ],
  },
  {
    ...
    badgeColor: "",
    summary:
      "Support the Head Chef in running a smooth, high-quality kitchen operation. You will be responsible for daily prep, service execution, and stepping up as acting Head Chef when required.",
    responsibilities: [
  ...
  },
  {
    ...
    summary:
      "Join our kitchen team and learn the craft of authentic Vietnamese cooking. Whether you are an experienced cook or an enthusiastic beginner, we will train you to the Saigon Express standard.",
    responsibilities: [
  ...
  },
  {
    ...
    summary:
      "Take ownership of the daily operations of a Saigon Express location. You will lead a team of up to 15 staff, drive sales performance, and ensure every guest leaves with a smile.",
    responsibilities: [
  ...
  },
  {
    ...
    badgeColor: "",
    summary:
      "Support the Restaurant Manager in running a high-performing location. This is an ideal role for an experienced senior FOH team member ready to take the next step into management.",
    responsibilities: [
    ...
    perks: [
      "30% staff meal discount",
      "Clear pathway to Restaurant Manager",
      "Paid training",
      "Uniform provided",
    ],
  },
  {
    ...
    badgeColor: "",
    summary:
      "Lead the floor during service, ensuring every guest receives a warm, efficient, and memorable Saigon Express experience. You will mentor junior FOH staff and be the first point of contact for guest feedback.",
    responsibilities: [
  ...
  },
  {
    ...
    summary:
      "Be the face of Saigon Express. We are always looking for warm, energetic, and guest-focused people to join our front-of-house team. No Vietnamese food experience required — just a genuine love of hospitality.",
    responsibilities: [
    ...
    perks: [
      "30% staff meal discount",
      "Flexible casual, part-time, or full-time hours",
      "Uniform provided",
      "Pathway to Team Leader and beyond",
    ],
  },
  {
    id: 8,
    ...
    badgeColor: "",
    summary:
      "Craft our Vietnamese iced coffee, homemade lemon tea, and full espresso menu for our guests. If you love coffee and Vietnamese drinks culture, this role is for you.",
    responsibilities: [
  ...
  },
  {
    ...
    badgeColor: "",
    summary:
      "Coordinate our growing catering and delivery operations across Greater Hobart. You will be the logistics backbone of our catering business, ensuring every order arrives on time, at temperature, and presented perfectly.",
    responsibilities: [
    ...
    perks: [
      "30% staff meal discount",
      "Company vehicle for deliveries",
      "Flexible hours",
      "Pathway to Operations Manager",
    ],
  },
  {
    id: 10,
    ...
    badgeColor: "",
    summary:
      "Grow our wholesale business across Tasmania. You will manage relationships with existing café, grocery, and hospitality partners, and actively prospect for new B2B accounts.",
    responsibilities: [
    ...
    perks: [
      "Commission structure on new accounts",
      "Company vehicle",
      "Expense account for client entertainment",
      "Career path to Sales Manager",
    ],
  },
  {
    id: 11,
    ...
    badgeColor: "",
    summary:
      "Tell the Saigon Express story to Tasmania and beyond. You will manage our social media presence, create content, run promotions, and help build one of Tasmania's most loved food brands.",
    responsibilities: [
  ...
  },
  {
    ...
    badgeColor: "",
    summary:
      "Support the growth of the Saigon Express franchise network. You will be the primary point of contact for new and existing franchisees, helping them succeed through training, compliance, and operational support.",
    responsibilities: [
...
const BENEFITS = [
  {
    icon: Star,
    title: "30% Staff Meal Discount",
    desc: "Enjoy 30% off your meal every time you work. We believe in looking after our team.",
  },
  {
    icon: Zap,
    title: "Fast Career Progression",
    desc: "We promote from within. Many of our managers and team leaders started as kitchen hands or FOH staff.",
  },
  {
    icon: Heart,
    title: "Inclusive, Supportive Culture",
    desc: "We celebrate diversity and welcome people from all backgrounds. Vietnamese culture is at our heart — and everyone is family.",
  },
  {
    icon: Users,
    title: "Team Events & Recognition",
    desc: "Quarterly team gatherings, staff awards, and a genuine culture of appreciation for the work you do.",
  },
  {
    icon: Briefcase,
    title: "Paid Training & Development",
    desc: "We invest in your growth — from food safety certificates to leadership workshops and barista training.",
  },
  {
    icon: MapPin,
    title: "Multiple Locations Across Tasmania",
    desc: "With 8 locations and more planned, there are opportunities close to where you live.",
  },
];
...
export default async function Careers() {
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
              We are building Tasmania's most loved Vietnamese food brand — and
              we want passionate, talented people to build it with us. From the
              kitchen to the counter, every role matters.
            </p>
            <a href="#positions">
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-3 max-w-xl mx-auto">
              We are a family-owned Tasmanian business with big ambitions. When
              you join us, you join a team that cares about food, people, and
              community.
            </p>
          </div>
      ...
      {/* Extracted Interactive Jobs Component */}
      <Jobs jobs={JOBS} />
      ...
      <section className="py-20 bg-[#1A1A1A] text-white">
        <div className="container text-center">
          ...
          <p className="text-white/60 text-lg max-w-xl mx-auto mb-10">
            Send your CV and a brief cover letter to our team. Tell us which
            role you're applying for and why Saigon Express is the right fit for
            you.
          </p>
          ...
          <p className="text-white/35 text-xs mt-8 max-w-lg mx-auto">
            Saigon Express Tasmania is an equal opportunity employer. We welcome
            applications from people of all backgrounds, including First Nations
            peoples, people with disability, and those from culturally and
